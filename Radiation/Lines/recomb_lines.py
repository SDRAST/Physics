...
def wavenumber (Z, n_f, n_i):
    """Given exposed nuclear charge, the final n and the
       initial n, returns the wavenumber in 1/m.
       DO NOT USE FOR RADIO FREQUENCIES.
       It's accurate enough for optical
